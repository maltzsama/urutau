...
Real [Chaos Mesh](https://chaos-mesh.org) runs in the pod e2e minikube
cluster, and the harness (`test/e2e/pods`) has primitives to create, observe
...
goroutine control standing in for it.
